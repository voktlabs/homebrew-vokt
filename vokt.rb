...
class Vokt < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/voktlabs/homebrew-vokt/releases/download/v2.0.52/vokt-darwin-arm64"
      sha256 "aecc597ae77965d432614279b3386a755f4baf3508acc390aa227e5131ef1851"
      ...
      url "https://github.com/voktlabs/homebrew-vokt/releases/download/v2.0.52/vokt-darwin-amd64"
      sha256 "ece0768fc49bb36b435683374f9a541faababd8277d3562a620c790753f21d5f"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/voktlabs/homebrew-vokt/releases/download/v2.0.52/vokt-linux-arm64"
      sha256 "6c048c5f20ed660a2e000ea990b3cf07cf970ac318d77b3908a9eb7253c5a053"
      ...
      url "https://github.com/voktlabs/homebrew-vokt/releases/download/v2.0.52/vokt-linux-amd64"
      sha256 "6e9b9d857a2b0b264433cead86971057d47375d16b912e6d4a926c2f006640a1"
  ...
  resource "java-engine" do
    url "https://github.com/voktlabs/homebrew-vokt/releases/download/v2.0.52/vokt-java-engine.jar"
  end

  # Tai-e runtime (LGPL, kept separate) — tarball of JARs
  resource "tai-e-deps" do
    url "https://github.com/voktlabs/homebrew-vokt/releases/download/v2.0.52/tai-e-deps.tar.gz"
  end
